...
5   O                      ux {4,[S,T,Q,B]} {7,[S,D,T,B,Q]}
6   R!H                    ux {1,[S,D,T,B,Q]}
7   [F,I,Br,Cl,C,O,Si,P,S] ux {5,[S,D,T,B,Q]}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
6   C                      u0 r1 {5,S} {8,S}
7   C                      ux {2,[S,D,T,B,Q]}
8   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {6,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
4   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {3,[S,D,T,B,Q]}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([-2.98152,-3.94616,-4.69243,-5.00419,-5.10333,-5.16393,-9.35278],'cal/mol/K','+|-',[3,3,3,3,3,3,3]),
        H298 = (97.8769,'kcal/mol','+|-',5.2),
        S298 = (5.23029,'cal/mol/K','+|-',3),
    ),
    shortDesc = """Radical correction fitted to 2 radicals""",
    longDesc = 
"""
...
4   C                      u0 r0 {2,S} {5,S}
5   O                      u0 r0 {4,S}
6   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {3,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
6   [F,I,Br,Cl,C,Si,P,S,N] u0 r1 {5,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
4   O                      u0 {3,[S,D,T,B,Q]}
5   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {3,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([-1.19689,-3.65999,-5.13183,-5.36014,-5.2415,-5.43693,-5.21591],'cal/mol/K','+|-',[3,3,3,3,3,3,3]),
        H298 = (85.411,'kcal/mol','+|-',5.2),
        S298 = (-0.350014,'cal/mol/K','+|-',3),
    ),
    shortDesc = """Radical correction fitted to 3 radicals""",
    longDesc = 
"""
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([-0.726635,-3.37076,-5.10828,-5.40203,-5.21577,-5.32687,-5.20801],'cal/mol/K','+|-',[3.32376,3,3,3,3,3,3]),
        H298 = (85.0698,'kcal/mol','+|-',5.2),
        S298 = (-0.581604,'cal/mol/K','+|-',3),
    ),
    shortDesc = """Radical correction fitted to 2 radicals""",
    longDesc = 
"""
...
6   C                      u0 r0 {5,D}
7   C                      u0 r0 {3,S}
8   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {4,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
4   C                      ux r0 {3,S} {5,[S,T,Q,B]}
5   O                      ux {4,[S,T,Q,B]} {6,S}
6   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {5,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
3   C                      ux r1 {2,D}
4   C                      ux r1 {2,[S,D,T,B,Q]}
5   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {1,D}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
5   C                      u0 r0 {1,S}
6   C                      u0 r0 {1,S} {7,[S,D,T,B,Q]}
7   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {6,[S,D,T,B,Q]}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
5   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {4,[S,D,T,B,Q]}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([-0.25467,-0.307543,-0.764203,-1.27758,-2.07336,-2.74261,-3.77461],'cal/mol/K','+|-',[3,3,3,3,3,3,3]),
        H298 = (88.641,'kcal/mol','+|-',5.2),
        S298 = (-0.930896,'cal/mol/K','+|-',3),
    ),
    shortDesc = """Radical correction fitted to 2 radicals""",
    longDesc = 
"""
...
4   O                      u0 {1,S}
5   C                      u0 {1,S} {6,[S,D,T,B,Q]}
6   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {5,[S,D,T,B,Q]}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
3   O                      ux {2,D}
4   C                      u0 {1,D} {5,S}
5   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {4,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
5   O                      ux {4,[S,D,T,B,Q]} {6,[S,D,T,B,Q]}
6   O                      ux {5,[S,D,T,B,Q]}
7   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {4,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
3   O                      u0 r1 {2,S} {4,S}
4   O                      u0 r1 {3,S}
5   [F,I,Br,Cl,C,Si,P,S,N] u0 r0 {1,[S,D,T,B,Q]}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
4   C                      ux {1,S} {6,S}
5   O                      ux {3,[S,D,T,B,Q]}
6   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {4,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
3   O                      ux {2,[S,T,Q,B]}
4   O                      ux {1,[S,D,T,B,Q]}
5   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {2,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([0.736023,-0.233601,-1.19783,-2.00698,-3.0948,-3.93582,-5.13044],'cal/mol/K','+|-',[3,3,3,3,3,3,3]),
        H298 = (103.012,'kcal/mol','+|-',5.2),
        S298 = (1.96607,'cal/mol/K','+|-',3),
    ),
    shortDesc = """Radical correction fitted to 3 radicals""",
    longDesc = 
"""
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([1.23154,-0.229595,-1.61887,-2.72006,-3.92586,-4.7876,-5.78903],'cal/mol/K','+|-',[3,3,3,3,3,3,3]),
        H298 = (101.788,'kcal/mol','+|-',5.2),
        S298 = (2.25253,'cal/mol/K','+|-',3),
    ),
    shortDesc = """Radical correction fitted to 2 radicals""",
    longDesc = 
"""
...
2   C                      u0 r0 {1,S} {3,S} {4,S}
3   O                      u0 r0 {2,S}
4   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {2,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
3   C                      u0 r1 {2,S} {4,S} {5,D}
4   C                      u0 r1 {2,S} {3,S}
5   [F,I,Br,Cl,O,Si,P,S,N] u0 r0 {3,D}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([-0.212585,-0.606258,-1.06611,-1.56567,-2.49488,-3.1368,-4.20393],'cal/mol/K','+|-',[2,2,2,2,2,2,2]),
        H298 = (110.68,'kcal/mol','+|-',2.4),
        S298 = (0.923809,'cal/mol/K','+|-',2),
    ),
    shortDesc = """Radical correction fitted to 3 radicals""",
    longDesc = 
"""
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([0.105275,-0.573096,-1.29223,-1.88138,-2.7446,-3.35374,-4.4983],'cal/mol/K','+|-',[3,3,3,3,3,3,3]),
        H298 = (112.278,'kcal/mol','+|-',5.2),
        S298 = (1.45693,'cal/mol/K','+|-',3),
    ),
    shortDesc = """Radical correction fitted to 3 radicals""",
    longDesc = 
"""
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([-0.115437,-0.485877,-1.05904,-1.63565,-2.59707,-3.33725,-4.46671],'cal/mol/K','+|-',[4.28938,3.41742,2.35637,2,2,2,2]),
        H298 = (111.53,'kcal/mol','+|-',2.4),
