...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([0.110476,-1.02793,-1.90081,-2.16573,-2.5119,-3.08347,-3.78293],'cal/mol/K','+|-',[3,3,3,3,3,3,3]),
        H298 = (92.0307,'kcal/mol','+|-',5.2),
        S298 = (-5.92845,'cal/mol/K','+|-',3),
    ),
    shortDesc = """Radical correction fitted to 2 radicals""",
    longDesc = 
"""
...
6   [P,F,I,Br,Cl,O,Si,S,N] u0 {5,[S,D,T,B,Q]}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
2   C                      u0 r1 {1,S} {3,S}
3   C                      u0 r1 {2,S} {4,S}
4   [P,F,I,Br,Cl,O,Si,S,N] u0 r1 {3,S}
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
...
""",
    thermo = ThermoData(
        Tdata = ([300,400,500,600,800,1000,1500],'K'),
        Cpdata = ([0.140327,-0.547542,-1.13048,-1.65162,-2.55797,-3.29564,-4.5123],'cal/mol/K','+|-',[2,2,2,2,2,2,2]),
        H298 = (103.883,'kcal/mol','+|-',2.4),
        S298 = (2.09074,'cal/mol/K','+|-',2),
    ),
    shortDesc = """Radical correction fitted to 2 radicals""",
    longDesc = 
"""
